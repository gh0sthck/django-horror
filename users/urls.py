...
from users.views import ProfileDeleteView, ProfileEditView, ProfileFavoritesList, ProfileFollowersView, ProfileStoriesView, ProfileSubscribesView, ProfileView, RegisterView
